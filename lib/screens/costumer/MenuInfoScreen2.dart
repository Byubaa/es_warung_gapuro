...
class MenuInfoScreen2 extends StatefulWidget {
  final String brandId;
  final String menuId;

  MenuInfoScreen2({required this.brandId, required this.menuId});

  @override
  _MenuInfoScreen2State createState() => _MenuInfoScreen2State();
}

class _MenuInfoScreen2State extends State<MenuInfoScreen2> {
  int quantity = 1;
